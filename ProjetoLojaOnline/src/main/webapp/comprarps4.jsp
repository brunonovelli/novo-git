...
<body>
	...
	<div align="center" id="imagem">
		<font size="50" color="red"> <a href=""><img align="center"
				src="Imagens/a.png" width="700" height="400"></img></a>
			...
			<a href="decisao.jsp"><input type="button" value="Comprar" class="btn btn-primary"
				name="Comprar"></a>
		</p>
			</p>
			<a href="index.jsp"><input type="button"
				value="Adiconar ao Carrinho" class="btn btn-primary" name="Adicionar ao Carrinho"></a>
		</p>
